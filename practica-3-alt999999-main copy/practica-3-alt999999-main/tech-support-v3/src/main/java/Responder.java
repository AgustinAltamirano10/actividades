...
public class Responder
{
    ...
    private void fillResponseMap()
    {
        responseMap.put("crash", 
                        "Well, it not ever crashes on our system. It must have something\n" +
        ...
        responseMap.put("buggy", 
                        "Well, you know, all software has a few bugs. But our software engineers\n" +
                        "are working very hard to fix them. Can you describe the problem a bit\n" +
                        "further?");
        ...
        responseMap.put("mac", 
                        "This is a realized bug to do with the Mac operating system. Please\n" +
        ...
        responseMap.put("java" ,"java is a languaje of programation");
        responseMap.put("code","code is a representation of a program in a text");
        responseMap.put("program","program is a ejecution of code and visualitation him in terminal");
        responseMap.put("why","¿what are you looking for?");
    }
    ...
    /**
     * @post Randomly select and return one of the default responses.
     */
    ...
    /**
     * @post Devuelve el mapa de respuestas.
     */
